...
@SourceType(value = "CventARP", label = "Cvent",uiConfig = "cvent-layout.json")
public class CventConf extends AbstractArpConf<CventConf> {
  private static final String ARP_FILENAME = "arp/implementation/cvent-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.cvent.CventDriver";
